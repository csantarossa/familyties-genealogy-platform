      ...
      <AccordionItem value="search" openItem={openItem} setOpenItem={setOpenItem}>
          ...
          <AccordionContent>
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Search Bar:</strong> Open the MyTree pane in the navbar, and select <b>"Search"</b>. Enter the person's first and/or last name and click <b>"Search"</b>. Note: If you don't know their full name, enter characters you know to be part of the name as it will still match available options. The matched nodes will glow green for 5 seconds.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="sidepanel" openItem={openItem} setOpenItem={setOpenItem}>
          ...
          <AccordionContent>
            <ul className="list-disc list-inside space-y-1">
              ...
              <li><strong>Update Notes:</strong> Navigate to the <b>"Notes"</b> tab in the side panel and click the text-box. Use this space in a way that is meaningful to you.</li>
              <li><strong>Verification:</strong> Person can be modified to <b>"Verified"</b> to ensure it's details are correct.</li>
        ...
        <AccordionItem value="manage" openItem={openItem} setOpenItem={setOpenItem}>
          ...
          <AccordionContent>
            <ul className="list-disc list-inside space-y-1">
              ...
              <li><strong>General Information:</strong> Click the edit button at the right-side of the side panel to modify <b>"Gender"</b>, <b>"Birth"</b>, <b>"Death"</b>, and <b>"Tags"</b> and click <b>"Save"</b> to finalise change(s).</li>
        ...
        <AccordionItem value="navbar" openItem={openItem} setOpenItem={setOpenItem}>
          ...
          <AccordionContent>
            <ul className="list-disc list-inside space-y-1">
              <li><strong>Logo:</strong> Click our <b>logo</b> to navigate to Trees Dashboard.</li>
              <li><strong>MyTree:</strong> You can add a person in the tree, search for a person in the tree, or import GEDCOM file to obtain a new tree.</li>
              <li><strong>Resources:</strong> <b>Tutorials</b> are for new users to learn how to utilise the app. <b>User Guides</b> is for user to know the features that are available in the app. <b>About the Team</b> is for user to meet the people behind FamilyTies. <b>Contact Us</b> is meant for user to reach out to the Team.</li>
              <li><strong>Account:</strong> <b>Preferences</b> is for user to enable dark mode and change language. <b>Settings</b> is for user to change username and password. <b>Log Out</b> is to logout from FamilyTies.</li>
            </ul>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
